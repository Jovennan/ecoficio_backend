...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post departamentos_url, params: { departamento: { nome: @departamento.nome, orgao_id: @departamento.orgao_id } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { nome: @departamento.nome, orgao_id: @departamento.orgao_id } }
