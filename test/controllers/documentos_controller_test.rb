...
class DocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post documentos_url, params: { documento: { autor_id: @documento.autor_id, brasao: @documento.brasao, descricao: @documento.descricao, nome: @documento.nome, orgao_id: @documento.orgao_id, titulo: @documento.titulo, visibilidade: @documento.visibilidade } }
    end
  ...
  test "should update documento" do
    patch documento_url(@documento), params: { documento: { autor_id: @documento.autor_id, brasao: @documento.brasao, descricao: @documento.descricao, nome: @documento.nome, orgao_id: @documento.orgao_id, titulo: @documento.titulo, visibilidade: @documento.visibilidade } }
